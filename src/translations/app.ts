...
export const app = {
  en: {
    ...
    dash: {
      ...
      gateWaitingTitle:     'We\'re setting things up — check back soon!',
      gatePasteLabel:      'Paste your GBP location ID to connect instantly:',
      gatePasteHint:       'Find it at business.google.com → your listing URL. Format: accounts/123456/locations/789012',
      gateSave:            'Save',
      gateRetryOauth:      'Or reconnect via Google instead',
      gateWaitingSub:      "This feature is under construction. Full Google Business Profile integration is coming very soon — thanks for your patience!",
      ...
      tabs: {
        ...
        'reply-review':  'Reply to Review',
        'answer-qa':     'Answer Q&A',
    ...
    photos: {
      ...
      uploadSuccessDesc:       'Description customers will see:',
      uploadSuccessKw:         'SEO keywords:',
      dropClick:               'Click to select photo',
      dropFormats:             'JPEG · PNG · WebP · max 15 MB',
      descriptionLabel:        'Description (customers see this on Google)',
      descriptionPlaceholder:  'Describe what the photo shows — e.g. "Tile backsplash install in Cabo. Waterproof grout, custom cuts." Claude will refine it for SEO.',
    ...
    privacy: {
      ...
      sections: [
        {
          title: '1. Overview',
          body: 'HayVista is a SaaS platform that allows business owners to connect and automate their Google Business Profile. This policy explains what data we collect, how we use it, and your rights regarding that data. HayVista operates in strict compliance with the Google API Services User Data Policy, including all Limited Use requirements.',
        },
        {
          ...
          bullets: [
            ...
            'An OAuth 2.0 access token and refresh token scoped to the business.manage scope — used exclusively to interact with your own Google Business Profile',
            'Business location data, posts, photos, reviews, and Q&A from your connected Google Business Profile',
          ],
        },
        {
          ...
          bullets: [
            ...
            'Read your Google Business Profile data to power AI content generation (posts, review replies, Q&A answers)',
            'Publish content to your own Google Business Profile on your behalf and only with your authorization',
            'Display your profile information within the HayVista dashboard',
          ],
          footer: 'We do not sell, share, or expose your data to third parties for advertising, analytics, or any other purpose.',
        },
        {
          title: '4. Google Business Profile API — Limited Use Disclosure',
          body: "HayVista accesses Google Business Profile (GBP) data solely on behalf of authenticated users who have explicitly granted permission via Google OAuth 2.0 using the business.manage scope. This access is limited to the authenticated user's own GBP listing only — HayVista never accesses any other business's data.",
          intro: 'GBP data (business info, photos, posts, reviews, Q&A) is used exclusively to:',
          bullets: [
            "Generate AI-drafted posts, review replies, and Q&A answers for the user's own profile",
            'Display profile information and performance insights within the HayVista dashboard',
            "Match the user's real GBP photos to post content using AI vision",
            'Build a persistent business memory document that improves AI output accuracy over time',
          ],
          footer: 'HayVista does not use GBP data to serve advertisements, does not allow humans to read user data except when required for support at the user\'s explicit request, does not transfer GBP data to third parties except to Anthropic (Claude AI, used solely for AI content generation under strict data processing terms), and does not use GBP data for any purpose that is not directly related to providing the HayVista service to the authenticated user.',
          revoke: "Users can revoke HayVista's access to their Google account at any time by visiting",
          revokeSuffix: '. Upon revocation, all OAuth tokens will be invalidated and all associated GBP data will be deleted from our systems within 30 days.',
          ...
          policySuffix: ', including all Limited Use requirements.',
        },
        {
          title: '5. Data Storage and Security',
          body: 'OAuth tokens and business data are stored in an encrypted PostgreSQL database hosted on Railway (US region). Access tokens are used only to make API calls on behalf of the authenticated user and are never logged or exposed. We implement industry-standard security practices including HTTPS, session encryption, and minimal data retention.',
        },
        {
          title: '6. Data Retention',
          body: 'We store your account information and OAuth tokens for as long as your account is active. AI-generated content drafts (posts, replies, answers) are retained to support the 24-hour review window and your content history. You may request full deletion of your account and all associated data at any time by contacting us.',
        },
        {
          title: '7. Your Rights',
          ...
          bullets: [
            ...
            'Revoke Google OAuth access at any time via your Google Account settings at myaccount.google.com/permissions',
            'Opt out of AI content generation at any time by canceling your subscription',
          ],
        },
        {
          title: '8. Contact',
  ...
  es: {
    ...
    dash: {
      ...
      gateWaitingTitle:     '¡Estamos preparando todo — vuelve pronto!',
      gatePasteLabel:      'Pega tu ID de ubicación de GBP para conectarte al instante:',
      gatePasteHint:       'Encuéntralo en business.google.com → URL de tu perfil. Formato: accounts/123456/locations/789012',
      gateSave:            'Guardar',
      gateRetryOauth:      'O reconectar vía Google',
      gateWaitingSub:      'Esta función está en construcción. La integración completa con Google Business Profile llega muy pronto — ¡gracias por tu paciencia!',
      ...
      tabs: {
        ...
        memory:           'Memoria IA',
        manual:           'Herramientas IA',
        'write-post':     'Redactar Post',
        'reply-review':   'Responder Reseña',
        'answer-qa':      'Responder Q&A',
        'process-images': 'Procesar Fotos',
    ...
    photos: {
      ...
      uploadSuccessDesc:       'Descripción que verán los clientes:',
      uploadSuccessKw:         'Palabras clave SEO:',
      dropClick:               'Haz clic para seleccionar foto',
      dropFormats:             'JPEG · PNG · WebP · máx. 15 MB',
      descriptionLabel:        'Descripción (los clientes la ven en Google)',
      descriptionPlaceholder:  'Describe lo que muestra la foto — ej. "Instalación de azulejos en baño, Cabo San Lucas. Lechada impermeable, cortes personalizados." Claude la ajustará para SEO.',
    ...
    privacy: {
      ...
      sections: [
        {
          title: '1. Resumen',
          body: 'HayVista es una plataforma SaaS que permite a los propietarios de negocios conectar y automatizar su Perfil de Negocio de Google. Esta política explica qué datos recopilamos, cómo los usamos y tus derechos sobre esos datos. HayVista opera en estricto cumplimiento con la Política de Datos de Usuario de los Servicios de API de Google, incluidos todos los requisitos de Uso Limitado.',
        },
        {
          ...
          bullets: [
            ...
            'Un token de acceso y actualización OAuth 2.0 con alcance business.manage — utilizado exclusivamente para interactuar con tu propio Perfil de Negocio de Google',
            'Datos de ubicación, publicaciones, fotos, reseñas y preguntas y respuestas de tu Perfil de Negocio de Google conectado',
          ],
        },
        {
          ...
          bullets: [
            ...
            'Leer los datos de tu Perfil de Negocio de Google para generar contenido con IA (publicaciones, respuestas a reseñas, respuestas a preguntas)',
            'Publicar contenido en tu propio Perfil de Negocio de Google en tu nombre y solo con tu autorización',
            'Mostrar la información de tu perfil dentro del panel de HayVista',
          ],
          footer: 'No vendemos, compartimos ni exponemos tus datos a terceros para publicidad, análisis ni ningún otro propósito.',
        },
        {
          title: '4. API de Google Business Profile — Declaración de Uso Limitado',
          body: 'HayVista accede a los datos del Perfil de Negocio de Google (GBP) únicamente en nombre de usuarios autenticados que han otorgado permiso explícito mediante Google OAuth 2.0 usando el alcance business.manage. Este acceso está limitado únicamente al propio listado GBP del usuario autenticado — HayVista nunca accede a los datos de ningún otro negocio.',
          intro: 'Los datos de GBP (información del negocio, fotos, publicaciones, reseñas, preguntas y respuestas) se usan exclusivamente para:',
          bullets: [
            'Generar publicaciones, respuestas a reseñas y respuestas a preguntas con IA para el propio perfil del usuario',
            'Mostrar información del perfil e información de rendimiento dentro del panel de HayVista',
            'Emparejar las fotos reales del usuario con el contenido de las publicaciones mediante visión artificial',
            'Crear un documento de memoria empresarial persistente que mejora la precisión del contenido con IA con el tiempo',
          ],
          footer: 'HayVista no usa datos de GBP para mostrar anuncios, no permite que personas lean los datos del usuario excepto cuando sea necesario para soporte a solicitud explícita del usuario, no transfiere datos de GBP a terceros excepto a Anthropic (Claude AI, usado exclusivamente para la generación de contenido con IA bajo términos estrictos de procesamiento de datos), y no usa datos de GBP para ningún propósito no relacionado directamente con brindar el servicio de HayVista al usuario autenticado.',
          revoke: 'Los usuarios pueden revocar el acceso de HayVista a su cuenta de Google en cualquier momento visitando',
          revokeSuffix: '. Al revocar, todos los tokens OAuth serán invalidados y todos los datos de GBP asociados serán eliminados de nuestros sistemas en un plazo de 30 días.',
          ...
          policySuffix: ', incluidos todos los requisitos de Uso Limitado.',
        },
        {
          title: '5. Almacenamiento y seguridad de datos',
          body: 'Los tokens OAuth y los datos del negocio se almacenan en una base de datos PostgreSQL cifrada alojada en Railway (región EE. UU.). Los tokens de acceso se usan únicamente para realizar llamadas a la API en nombre del usuario autenticado y nunca se registran ni exponen. Implementamos prácticas de seguridad estándar de la industria, incluyendo HTTPS, cifrado de sesión y retención mínima de datos.',
        },
        {
          title: '6. Retención de datos',
          body: 'Almacenamos la información de tu cuenta y los tokens OAuth durante el tiempo que tu cuenta esté activa. Los borradores de contenido generado con IA (publicaciones, respuestas, preguntas) se retienen para el período de revisión de 24 horas y tu historial de contenido. Puedes solicitar la eliminación completa de tu cuenta y todos los datos asociados en cualquier momento contactándonos.',
        },
        {
          ...
          bullets: [
            ...
            'Revocar el acceso de Google OAuth en cualquier momento a través de myaccount.google.com/permissions',
            'Optar por no recibir contenido generado con IA en cualquier momento cancelando tu suscripción',
          ],
        },
        {
          title: '8. Contacto',
